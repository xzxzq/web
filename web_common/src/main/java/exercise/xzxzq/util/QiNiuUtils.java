...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "g79HKwxbEE8FNVskuFTcpwrntF2Pj6dNH8QA7xCj";
    private static final String SECRETKEY = "UX8AO52ACFfRjx6ARU5hWXfiumIagYquv6AiHEH1";
    private static final String BUCKET = "megal";
    public static final String DOMAIN = "http://qmpogx42h.hn-bkt.clouddn.com/";
